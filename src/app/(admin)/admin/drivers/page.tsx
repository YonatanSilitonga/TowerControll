...
const columns: Column<DriverAdmin>[] = [
  ...
  { header: "Nama Driver", render: (r) => <span className="font-medium text-slate-800 dark:text-white">{r.nama_driver}</span> },
  ...
  { header: "Status", className: "w-24", render: (r) => (
    <span className={`inline-flex rounded-full px-2 py-0.5 text-[10px] font-bold ${
      r.status_driver === "aktif" ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400"
