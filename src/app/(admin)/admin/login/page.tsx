    ...
    <div className="flex min-h-screen bg-[#0c1e3a]">
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-[380px]">
          ...
          {/* Badge */}
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-amber-400/20 bg-amber-400/10 px-3.5 py-1.5">
            <Shield className="h-3.5 w-3.5 text-amber-400" />
            <span className="text-[11px] font-semibold text-amber-400">Administrator Access</span>
          </div>

          <h2 className="text-2xl font-bold tracking-tight text-white">Masuk ke Admin Panel</h2>
          <p className="mt-1.5 text-sm text-slate-400">Gunakan akun admin untuk mengakses panel ini.</p>

          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            {error && (
              <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 px-4 py-3 text-sm font-medium text-rose-300">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required
                autoFocus
                className="h-11 w-full rounded-lg border border-slate-600/50 bg-white/5 px-4 text-sm text-white placeholder-slate-500 outline-none transition-colors focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="h-11 w-full rounded-lg border border-slate-600/50 bg-white/5 px-4 pr-11 text-sm text-white placeholder-slate-500 outline-none transition-colors focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20"
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-amber-500 text-sm font-bold text-[#0c1e3a] shadow-lg shadow-amber-500/20 transition-all hover:bg-amber-400 hover:shadow-amber-500/30 disabled:opacity-50"
            >
              {loading ? (
          ...
          <p className="mt-8 text-center text-xs text-slate-500">
            <a href="/login" className="text-slate-400 underline underline-offset-2 decoration-slate-600 hover:text-white transition-colors">
