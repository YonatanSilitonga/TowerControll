  ...
  return (
    <div className="space-y-5 pb-12">
      ...
      <div className="flex w-full flex-col gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2.5 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800 dark:bg-slate-900">
        ...
        {/* Baris 2 (mobile): Driver + Search + Refresh */}
        <div className="flex items-center gap-2">
          <select
            value={selectedDriverId}
            onChange={(e) => setSelectedDriverId(e.target.value)}
            className="h-7 flex-1 rounded-md border border-slate-200 bg-white px-2 text-[11px] font-medium text-slate-700 focus:border-[#0c1e3a] focus:outline-none sm:flex-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
          >
          ...
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              className="h-7 w-full rounded-md border border-slate-200 bg-white pl-7 pr-2 text-[11px] focus:border-[#0c1e3a] focus:outline-none sm:w-48 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
            />
          </div>
              ...
              <div className="flex flex-1 flex-col p-3">
                ...
                <div className="mt-auto flex flex-wrap items-center gap-1 pt-2 border-t border-slate-100 dark:border-slate-800/80">
                  ...
                  <button
                    ...
                    className="ml-auto flex h-7 w-7 items-center justify-center rounded border border-slate-200 bg-slate-50 text-slate-400 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800"
                    title="Unduh"
                  >
