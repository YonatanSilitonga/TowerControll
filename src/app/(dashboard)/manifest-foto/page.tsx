...
export default function ManifestFotoPage() {
  ...
  return (
    <div className="space-y-5 pb-12">
      ...
      {/* ── Ringkasan Muatan — 3 kartu dalam section ── */}
      ...
      <div className="flex w-full flex-col gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2.5 dark:border-slate-800 dark:bg-slate-900">
        ...
        {/* Baris 2: Driver dropdown */}
        <select
          value={selectedDriverId}
          onChange={(e) => setSelectedDriverId(e.target.value)}
          className="h-8 w-full rounded-md border border-slate-200 bg-white px-2 text-[11px] font-medium text-slate-700 focus:border-[#0c1e3a] focus:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
        >
